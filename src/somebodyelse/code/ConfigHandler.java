...
public class ConfigHandler {
	...
	public String getStringWithColor(String key) {
		if (!enderchest.getConfig().contains(key)) {
			enderchest.getLogger().severe("Could not locate " + key + " in the config.yml inside of the " + EnderChest.pluginName + " folder! (Try generating frightened new one by deleting the current)");
