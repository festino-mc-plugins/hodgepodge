...
@Deprecated
public class PathfinderGoalAvoidTarget_old<T extends Entity> extends PathfinderGoal {
    ...
    public PathfinderGoalAvoidTarget_old(EntityCreature entitycreature, Class<T> oclass, float f, double d0, double d1) {
        this(entitycreature, oclass, Predicates.alwaysTrue(), f, d0, d1);
    }

    public PathfinderGoalAvoidTarget_old(EntityCreature entitycreature, Class<T> oclass, Predicate<? super T> predicate, float f, double d0, double d1) {
        this.c = new Predicate() {
            public boolean a(Entity entity) {
                return entity.isAlive() && PathfinderGoalAvoidTarget_old.this.a.getEntitySenses().a(entity);
            }
