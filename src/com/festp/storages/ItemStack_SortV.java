...
public class ItemStack_SortV implements Comparable {
	...
	private static int get(Material m) {
		...
		case DEEPSLATE: 						g++;
		case COBBLED_DEEPSLATE: 						g++;
		case POLISHED_DEEPSLATE: 						g++;
		case CALCITE: 						g++;
		case TUFF: 						g++;
		case DRIPSTONE_BLOCK: 						g++;
		case GRASS_BLOCK: 						g++;
		case DIRT: 						g++;
		case COARSE_DIRT: 						g++;
		case PODZOL: 						g++;
		...
		case GRAVEL: 						g++;
		case COAL_ORE: 						g++;
		case DEEPSLATE_COAL_ORE: 						g++;
		case IRON_ORE: 						g++;
		case DEEPSLATE_IRON_ORE: 						g++;
		case COPPER_ORE: 						g++;
		case DEEPSLATE_COPPER_ORE: 						g++;
		case GOLD_ORE: 						g++;
		case DEEPSLATE_GOLD_ORE: 						g++;
		case REDSTONE_ORE: 						g++;
		case DEEPSLATE_REDSTONE_ORE: 						g++;
		case EMERALD_ORE: 						g++;
		case DEEPSLATE_EMERALD_ORE: 						g++;
		case LAPIS_ORE: 						g++;
		case DEEPSLATE_LAPIS_ORE: 						g++;
		case DIAMOND_ORE: 						g++;
		case DEEPSLATE_DIAMOND_ORE: 						g++;
		case NETHER_GOLD_ORE: 						g++;
		case NETHER_QUARTZ_ORE: 						g++;
		case ANCIENT_DEBRIS: 						g++;
		case COAL_BLOCK: 						g++;
		case RAW_IRON_BLOCK: 						g++;
		case RAW_COPPER_BLOCK: 						g++;
		case RAW_GOLD_BLOCK: 						g++;
		case AMETHYST_BLOCK: 						g++;
		case BUDDING_AMETHYST: 						g++;
		case IRON_BLOCK: 						g++;
		case COPPER_BLOCK: 						g++;
		case GOLD_BLOCK: 						g++;
		...
		case EXPOSED_COPPER: 						g++;
		case WEATHERED_COPPER: 						g++;
		case OXIDIZED_COPPER: 						g++;
		case CUT_COPPER: 						g++;
		case EXPOSED_CUT_COPPER: 						g++;
		case WEATHERED_CUT_COPPER: 						g++;
		case OXIDIZED_CUT_COPPER: 						g++;
		case CUT_COPPER_STAIRS: 						g++;
		case EXPOSED_CUT_COPPER_STAIRS: 						g++;
		case WEATHERED_CUT_COPPER_STAIRS: 						g++;
		case OXIDIZED_CUT_COPPER_STAIRS: 						g++;
		case CUT_COPPER_SLAB: 						g++;
		case EXPOSED_CUT_COPPER_SLAB: 						g++;
		case WEATHERED_CUT_COPPER_SLAB: 						g++;
		case OXIDIZED_CUT_COPPER_SLAB: 						g++;
		case WAXED_COPPER_BLOCK: 						g++;
		case WAXED_EXPOSED_COPPER: 						g++;
		case WAXED_WEATHERED_COPPER: 						g++;
		case WAXED_OXIDIZED_COPPER: 						g++;
		case WAXED_CUT_COPPER: 						g++;
		case WAXED_EXPOSED_CUT_COPPER: 						g++;
		case WAXED_WEATHERED_CUT_COPPER: 						g++;
		case WAXED_OXIDIZED_CUT_COPPER: 						g++;
		case WAXED_CUT_COPPER_STAIRS: 						g++;
		case WAXED_EXPOSED_CUT_COPPER_STAIRS: 						g++;
		case WAXED_WEATHERED_CUT_COPPER_STAIRS: 						g++;
		case WAXED_OXIDIZED_CUT_COPPER_STAIRS: 						g++;
		case WAXED_CUT_COPPER_SLAB: 						g++;
		case WAXED_EXPOSED_CUT_COPPER_SLAB: 						g++;
		case WAXED_WEATHERED_CUT_COPPER_SLAB: 						g++;
		case WAXED_OXIDIZED_CUT_COPPER_SLAB: 						g++;
		case OAK_LOG: 						g++;
		case SPRUCE_LOG:  						g++;
		case BIRCH_LOG: 						g++;
		case JUNGLE_LOG: 						g++;
		...
		case SMOOTH_BASALT: 						g++;
		case GLOWSTONE: 						g++;
		case STONE_BRICKS: 						g++;
		case MOSSY_STONE_BRICKS: 						g++;
		case CRACKED_STONE_BRICKS: 						g++;
		case CHISELED_STONE_BRICKS: 						g++;
		case DEEPSLATE_BRICKS: 						g++;
		case CRACKED_DEEPSLATE_BRICKS: 						g++;
		case DEEPSLATE_TILES: 						g++;
		case CRACKED_DEEPSLATE_TILES: 						g++;
		case CHISELED_DEEPSLATE: 						g++;
		case BRICK_STAIRS: 						g++;
		...
		case COBBLED_DEEPSLATE_STAIRS: 						g++;
		case POLISHED_DEEPSLATE_STAIRS: 						g++;
		case DEEPSLATE_BRICK_STAIRS: 						g++;
		case DEEPSLATE_TILE_STAIRS: 						g++;
		...
		case DIORITE_SLAB: 						g++;
		case COBBLED_DEEPSLATE_SLAB: 						g++;
		case POLISHED_DEEPSLATE_SLAB: 						g++;
		case DEEPSLATE_BRICK_SLAB: 						g++;
		case DEEPSLATE_TILE_SLAB: 						g++;
		...
		case AZALEA_LEAVES: 						g++;
		case FLOWERING_AZALEA_LEAVES: 						g++;
		case COBWEB: 						g++;
		case GRASS: 						g++;
		case FERN: 						g++;
		case AZALEA: 						g++;
		case FLOWERING_AZALEA: 						g++;
		case DEAD_BUSH: 						g++;
		case SEAGRASS: 						g++;
		case SEA_PICKLE: 						g++;
		case DANDELION: 						g++;
		...
		case MOSS_CARPET: 						g++;
		case MOSS_BLOCK: 						g++;
		case HANGING_ROOTS: 						g++;
		case BIG_DRIPLEAF: 						g++;
		case SMALL_DRIPLEAF: 						g++;
		case BAMBOO: 						g++;
		case TORCH: 						g++;
		case END_ROD: 						g++;
		case CHORUS_PLANT: 						g++;
		...
		case COBBLED_DEEPSLATE_WALL: 						g++;
		case POLISHED_DEEPSLATE_WALL: 						g++;
		case DEEPSLATE_BRICK_WALL: 						g++;
		case DEEPSLATE_TILE_WALL: 						g++;
		case ANVIL: 						g++;
		...
		case CANDLE:  						g++;
		case WHITE_CANDLE: 						g++;
		case ORANGE_CANDLE: 						g++;
		case MAGENTA_CANDLE: 						g++;
		case LIGHT_BLUE_CANDLE: 						g++;
		case YELLOW_CANDLE: 						g++;
		case LIME_CANDLE: 						g++;
		case PINK_CANDLE: 						g++;
		case GRAY_CANDLE: 						g++;
		case LIGHT_GRAY_CANDLE: 						g++;
		case CYAN_CANDLE: 						g++;
		case PURPLE_CANDLE: 						g++;
		case BLUE_CANDLE: 						g++;
		case BROWN_CANDLE: 						g++;
		case GREEN_CANDLE: 						g++;
		case RED_CANDLE: 						g++;
		case BLACK_CANDLE: 						g++;
		case SMALL_AMETHYST_BUD: 						g++;
		case MEDIUM_AMETHYST_BUD: 						g++;
		case LARGE_AMETHYST_BUD: 						g++;
		case AMETHYST_CLUSTER: 						g++;
		case POINTED_DRIPSTONE: 						g++;
