...
public class PaletteUtils {
	...
	{
		final int max_color = (61+1) * SHADES_COUNT;
		int color = max_color;
		switch (material)
		{
		// TRANSPARENT GRAY
		...
		case CAVE_VINES: case SPORE_BLOSSOM: case AZALEA: case FLOWERING_AZALEA: case BIG_DRIPLEAF: case SMALL_DRIPLEAF:
			color -= SHADES_COUNT;
		// SNOW
		...
		case COAL_ORE: case IRON_ORE: case GOLD_ORE: case REDSTONE_ORE: case LAPIS_ORE: case DIAMOND_ORE: case EMERALD_ORE: case COPPER_ORE:
		...
		case WARPED_WART_BLOCK:
			color -= SHADES_COUNT;
		// DEEPSLATE
		case DEEPSLATE: case COBBLED_DEEPSLATE: case COBBLED_DEEPSLATE_SLAB: case COBBLED_DEEPSLATE_STAIRS: case COBBLED_DEEPSLATE_WALL:
		case DEEPSLATE_BRICKS: case DEEPSLATE_BRICK_SLAB: case DEEPSLATE_BRICK_STAIRS: case DEEPSLATE_BRICK_WALL:
		case CRACKED_DEEPSLATE_BRICKS: case CRACKED_DEEPSLATE_TILES:
		case POLISHED_DEEPSLATE_SLAB: case POLISHED_DEEPSLATE_STAIRS: case POLISHED_DEEPSLATE_WALL:
		case DEEPSLATE_TILES: case DEEPSLATE_TILE_SLAB: case DEEPSLATE_TILE_STAIRS: case DEEPSLATE_TILE_WALL:
		case DEEPSLATE_COAL_ORE: case DEEPSLATE_COPPER_ORE: case DEEPSLATE_IRON_ORE: case DEEPSLATE_LAPIS_ORE:
		case DEEPSLATE_GOLD_ORE: case DEEPSLATE_EMERALD_ORE: case DEEPSLATE_REDSTONE_ORE: case DEEPSLATE_DIAMOND_ORE:
